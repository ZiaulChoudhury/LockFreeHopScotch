...
bool LFHash::add(unsigned int key, int threadID)
{
    unsigned long  Entry;
    unsigned long tag=0;
...
bool LFHash::Eliminate(unsigned int key, int threadId, int mySLot, int initialSlot)
{
...
unsigned int LFHash::Relocate(unsigned int Loc, long NewEntry)
{
...
bool LFHash::contains(unsigned int key)
{
